#!/bin/bash
export cmdargs=$*
cd $MSSCFHOME\\v2_13-maven\\org.msscf.msscf.v2_13.CFCli\\target
if [ "$LOG4J2_CONF" != "" ]; then
	export JAVA_LOG4J="-Dlog4j.configurationFile=$LOG4J2_CONF"
else
	export JAVA_LOG4J=""
fi
"$JAVA" $JAVA_LOG4J -ea -Xms1023M -jar .\\org.msscf.msscf.v2_13.CFCli-2.13.11197-spring-boot.jar $cmdargs
